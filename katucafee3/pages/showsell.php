...
<div class="container">
    <div class="d-flex">
        ...
        <form class="d-flex w-25" method="get" id="filterForm">
            ...
            <button class="btn btn-success" type="submit" style="display: none;">ຄົ້ນຫາ</button> <!-- Hidden button -->
        </form>
    </div>
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="bg-light text-dark mt-3 rounded d-flex flex-column border border-secondary p-3">
                ...
                <form id="frmpayment">
                    <div class="mb-2 d-flex gap-1 p-3">
                        <input class="form-control" type="search" id="Price" name="search" placeholder="ຈໍານວນເງິນ" autocomplete="off">
                        <button class="btn btn-outline-primary text-light btn-success" id="btnfull">ຈ່າຍເຕັມ</button>
                    </div>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        document.getElementById("printBill").addEventListener("click", function(event) {
            ...
            fetch("../backend/sell/binsert.php", {method: "POST",})
